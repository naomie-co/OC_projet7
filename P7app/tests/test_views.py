...
def test_get_coordinate(monkeypatch):
	...
	def w_request():
		return {'batchcomplete': '', 'query': {'normalized': [{'from': 'lyon', 'to': 'Lyon'}], 'pages': {'802627': {'pageid': 802627, 'ns': 0, 'title': 'Lyon', 'coordinates': [{'lat': 45.759723, 'lon': 4.842223, 'primary': '', 'globe': 'earth'}]}}}}
